                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="border border-[#222222] bg-black p-6 rounded">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div
                                className={`text-4xl font-bold ${alert.riskScore >= 80
                                        ? 'text-white'
                                        : alert.riskScore >= 50
                                            ? 'text-[#EDEDED]'
                                            : 'text-[#888888]'
                        ...
                        <div className="h-2 bg-[#050505] rounded-full overflow-hidden">
                            <motion.div
                                ...
                                className={`h-full ${alert.riskScore >= 80
                                        ? 'bg-white'
                                        : alert.riskScore >= 50
                                            ? 'bg-[#EDEDED]'
                                            : 'bg-[#888888]'
                    ...
                    <div className="border border-[#222222] bg-black p-6 rounded">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                <span className="text-[#888888]">Alert Type:</span>
                                <p className="text-[#EDEDED] mt-1">{alert.type}</p>
                            </div>
                            <div>
                                <span className="text-[#888888]">Created:</span>
                                <p className="text-[#EDEDED] mt-1">{new Date(alert.timestamp).toLocaleString('en-IN')}</p>
                            </div>
                        </div>
                    </div>
