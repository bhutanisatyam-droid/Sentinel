    ...
    <div>
      ...
      <div className="border border-[#222222] rounded p-8 bg-[#050505]">
        <div className="space-y-4">
          ...
          {/* Demo Skip Button - visible during screening */}
          {screening && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <button
                onClick={() => {
                  setResults([
                    { list: 'UN Sanctions List', status: 'clear' },
                    { list: 'OFAC SDN List', status: 'clear' },
                    { list: 'EU Financial Sanctions', status: 'clear' },
                    { list: 'UAPA (India)', status: 'clear' },
                    { list: 'PEP Database', status: 'clear' },
                  ]);
                  setScreening(false);
